import { UserSignInType, UserSignUpType, userSignInSchema, userSignUpSchema } from "@repo/typing/user";
...
user.get("/signin", async (c) => {
    ...
    try {
        ...
        const refreshToken = await createRefreshToken(secret, algo, { id: randomUuid })
